...
# Uso: bash verify_enola.sh enola-cli-v0.5.0-alpha-x86_64-linux.tar.gz
...
```
enola-cli-v0.5.0-alpha-x86_64-linux.tar.gz          ← Binario público para usuarios
enola-cli-v0.5.0-alpha-x86_64-linux.tar.gz.sha256   ← Hash SHA256 (integridad)
enola-cli-v0.5.0-alpha-x86_64-linux.tar.gz.minisig  ← Firma minisign (autoría)
```
...
enola-cli-v0.5.0-alpha-x86_64-linux.tar.gz          ← Binario público para usuarios
enola-cli-v0.5.0-alpha-x86_64-linux.tar.gz.sha256   ← Hash SHA256 (integridad)
enola-cli-v0.5.0-alpha-x86_64-linux.tar.gz.minisig  ← Firma clásica (Ed25519)
enola-cli-v0.5.0-alpha-x86_64-linux.tar.gz.pqsig    ← Firma post-cuántica (ML-DSA-65)
```
