...
# Usage: bash verify_enola.sh enola-cli-v0.4.0-alpha-x86_64-linux.tar.gz
...
```
enola-cli-v0.4.0-alpha-x86_64-linux.tar.gz          ← Public binary for users
enola-cli-v0.4.0-alpha-x86_64-linux.tar.gz.sha256   ← SHA256 hash (integrity)
enola-cli-v0.4.0-alpha-x86_64-linux.tar.gz.minisig  ← Minisign signature (authorship)
```
...
enola-cli-v0.4.0-alpha-x86_64-linux.tar.gz          ← Public binary for users
enola-cli-v0.4.0-alpha-x86_64-linux.tar.gz.sha256   ← SHA256 hash (integrity)
enola-cli-v0.4.0-alpha-x86_64-linux.tar.gz.minisig  ← Classic signature (Ed25519)
enola-cli-v0.4.0-alpha-x86_64-linux.tar.gz.pqsig    ← Post-quantum signature (ML-DSA-65)
```
