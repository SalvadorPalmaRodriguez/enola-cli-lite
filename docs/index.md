...
```bash
# Install
wget https://github.com/SalvadorPalmaRodriguez/enola-cli-lite/releases/latest/download/enola-cli-v0.1.0-alpha-x86_64-linux-client.tar.gz
tar xf enola-cli-v0.1.0-alpha-x86_64-linux-client.tar.gz
...
See the [Quick Start Guide](en/quickstart.md) for the full walkthrough.
...
|----------|-------------|
| [Quick Start](en/quickstart.md) | Get your first .onion service running in 5 minutes |
| [Commands](en/commands.md) | Full command index — all modules and subcommands |
| [Concepts](en/concepts.md) | Architecture: Tor, Nginx port chain, Docker, AppArmor, PQC |
| [FAQ](en/faq.md) | Frequently asked questions |
| [Security Model](en/security-model.md) | Threat model, credential protection, binary integrity |
| [Verify Downloads](en/verify-downloads.md) | How to verify SHA256 + minisign + ML-DSA-65 signatures |

---

## Spanish documentation (original)
